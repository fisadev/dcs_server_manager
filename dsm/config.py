...
BASE_CONFIG = {
    ...
    "DCS_SERVER_CHECK_INTERVAL_SECONDS": 60,
    "DCS_SERVER_START_IF_NOT_RUNNING": True,
    "DCS_SERVER_DAILY_RESTART_AT_HOUR": None,

    # srs server configs
    "SRS_SERVER_EXE_PATH": r"C:\Program Files\DCS-SimpleRadio-Standalone\SR-Server.exe",
    "SRS_SERVER_EXE_ARGUMENTS": "",
    "SRS_SERVER_CHECK_INTERVAL_SECONDS": 60,
    "SRS_SERVER_START_IF_NOT_RUNNING": True,
    "SRS_SERVER_DAILY_RESTART_AT_HOUR": None,
}
